 ...
 *
 * 접근 방법:
 * 인접 리스트로 인접한 구역을 저장했습니다.
 * 부분집합으로 풀면서 해당 구역을 포함하거나 포함하지 않는 경우를 생각했습니다.
 * 부분집합을 만들 때는 아무런 작업을 하지 않고, 부분집합이 완성됐을 때 2구역으로 나눌 수 있는지,
 * 나눌 수 있다면 인구 수의 차이는 어떤지 확인하고 min을 업데이트했습니다.
 */
public class b17471 {
